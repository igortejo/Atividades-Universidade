 ...
 * 
 * ATENÇÃO: NAO MODIFIQUE NENHUMA OUTRA CLASSE ALEM DE BatchLinkedListImpl !!!
 * Apenas o arquivo BatchLinkedListImpl.java sera transferido para o ambiente de testes!!!
 * 
 * @author campelo
 * @author adalberto
 *
...
public interface BatchLinkedList<T> extends DoubleLinkedList<T> {
	 ...
	 * da lista são consideradas entre 0 e N.
	 * 
	 * Ex: lista = [3,9,4,2].
	 ...
	 * elemento [Z], deve ser possivel obter a listas [Z,A,B], [A,Z,B] ou [A,B,Z].
	 *   
	 * 
	 ...
	 * - nao modifica (nem lanca excecao) caso o array de entrada seja vazio (length == 0)
	 * 
	 */
