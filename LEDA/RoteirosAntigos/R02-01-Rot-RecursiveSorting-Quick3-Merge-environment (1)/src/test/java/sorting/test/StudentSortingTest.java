...
public class StudentSortingTest {
	...
	private Integer[] entradaMenorQue4;
;
	...
	public void setUp() {
		...
		populaVetorTamanhoMenorQue4(new Integer[] { 30, 28, 7});
	...
	public void populaVetorTamanhoMenorQue4(Integer[] arrayPadrao) {
		this.entradaMenorQue4 = Arrays.copyOf(arrayPadrao, arrayPadrao.length);
	}
	 ...
	 * PARTE DO ARRAY.
	 */
	public void genericTestComArgumentos(Integer[] array, int leftIndex, int rightIndex) {
		Integer[] copy1 = {};
		if(array.length > 0){
		...
		Arrays.sort(copy1);
        Integer[] copy2 = Arrays.copyOfRange(array, leftIndex, rightIndex + 1);
		Assert.assertArrayEquals(copy1, copy2);
	}

       @Test
    public void testSort07() {
        genericTestComArgumentos(vetorTamPar, 3, 7);
    }

    @Test
    public void testSort08() {
    	genericTestComArgumentos(vetorTamImpar, 6, 9);
    }

    @Test
    public void testSort09() {
    	genericTestComArgumentos(vetorValoresIguais, 1, 5);
    }

    @Test
    public void testSort10() {
    	genericTestComArgumentos(vetorValoresRepetidos,1 , 5);
    }
    @Test
    public void testSort11() {
    	genericTestComArgumentos(entradaMenorQue4,0 , 2);
    }
}